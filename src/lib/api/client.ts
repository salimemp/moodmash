...
export const api = {
  ...
  post: <T = unknown>(endpoint: string, data?: RequestBody, options?: Omit<FetchOptions, 'method'>) =>
    fetchAPI<T>(endpoint, { ...options, method: 'POST', body: data }),

  put: <T = unknown>(endpoint: string, data?: RequestBody, options?: Omit<FetchOptions, 'method'>) =>
    fetchAPI<T>(endpoint, { ...options, method: 'PUT', body: data }),

  patch: <T = unknown>(endpoint: string, data?: RequestBody, options?: Omit<FetchOptions, 'method'>) =>
